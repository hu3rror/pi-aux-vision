 ...
 * 全部未认证的 provider 排后。
 */
export function groupVisionProviders(models: Model[], isAuthed: (m: Model) => boolean): VisionProviderGroup[] {
...
export function formatModelDescription(model: Model, authed: boolean): string {
